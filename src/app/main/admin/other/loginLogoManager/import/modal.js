...
export default class importModal {
    constructor($injector, resolveData) {
        ...
        this.$modal = $injector.get('$modal')({
            ...
            keyboard: false,
            placement: 'center',
            templateUrl: 'app/main/admin/other/loginLogoManager/import/modal.html',
            onHide: () => {
                this.$modal.destroy();
                this.$modal = null;
            }
        ...
        this.$modal.$scope.data = {
            file: undefined,
            imgSize:this.$state == 'p_7_2'? '125*56': '400*330',
            uploaded: false,
            btnStr: '确定导入',
            event: undefined,
            uploading: false,
    ...
    bindFn() {
        ...
        this.$modal.$scope.fn = {
            ...
            sure: function () {
                ...
                let  sendType = $state.params.departId == 'p_7_2'?'loginUpLogo':'loginLeftLogo'
                if (data.uploaded) {
                ...
                if (self.sendType=='loginUpLogo'&&data.file.size > 15000) {
                    // new toast(self.injector, {
                    //     str: '文件大小不超过15K',
                    //     position: 'right-top'
                    // }).warn();
                ...
                // 左侧logo暂定大小为 150k以内
                if (self.sendType=='loginLftLogo'&&data.file.size > 150000) {
                    // new toast(self.injector, {
                    //     str: '文件大小不超过15K',
                    //     position: 'right-top'
                    // }).warn();
                    self.toaster.pop({type:'warning',title:'文件大小不超过150K'});
                    return;
                }
                data.uploading = true;
                data.btnStr = '正在上传';
                ...
                reader.onload = function () {
                    ...
                    otherManagerService.addLoginLogo(params).then(result => {
