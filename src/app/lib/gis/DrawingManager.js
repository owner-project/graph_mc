...
var CUSTOM_CONFIG = window.CUSTOM_CONFIG ? JSON.parse(window.CUSTOM_CONFIG) : null;
...
(function() {
     ...
     */
    DrawingManager.prototype.open = function(opt) {
        if (!!opt && opt.drawingMode) {
            this._drawingType = opt.drawingMode;
        }
        // 判断绘制状态是否已经开启
    ...
    DrawingManager.prototype._initialize = function(map, opts) {
        ...
        if (this._opts.followText) {
            var t = this._followTitle = new BMap.Label(this._opts.followText, {offset : new BMap.Size(14, 14)});
    ...
    DrawingManager.prototype._bindCircle = function() {
        ...
        var startAction = function (e) {
            ...
            // 往地图上添加marker 2017-12-14 16:51:15 目的是半径框选需要特殊加一个点啊
            // 坑坑坑啊
            var myIcon = new BMap.Icon('data:image/png;base64,', new BMap.Size(6, 6));
            var marker = new BMap.Marker(e.point, {icon: myIcon});
            map.addOverlay(marker);
            me.circleMarkers = [];
            me.circleMarkers.push(marker);
            mask.enableEdgeMove();
        ...
        var moveAction = function(e) {
            ...
            me._dispatchMovelayComplete(circle, calculate, e);
        }
    ...
    DrawingManager.prototype._bindPolylineOrPolygon = function() {
        ...
        var startAction = function (e) {
            ...
            if (me._followTitle) {
                me._followTitle.setPosition(e.point)
        ...
        var mousemoveAction = function(e) {
            ...
            me._followTitle && me._followTitle.setPosition(e.point);
            baidu.stopBubble(e);
        }
    ...
    DrawingManager.prototype._addGeoUtilsLibrary = function () {
        if (!BMapLib.GeoUtils) {
            var baiduMapHost = 'https://api.map.baidu.com';
            var customConfig = CUSTOM_CONFIG;
            if( customConfig ) {
                customConfig = JSON.parse(customConfig);
            }
            if( customConfig && !!customConfig.BAIDU_MAP_HOST ){
                baiduMapHost = customConfig.BAIDU_MAP_HOST;
            }
            var script = document.createElement('script');
            script.setAttribute("type", "text/javascript");
            script.setAttribute("src", baiduMapHost + '/library/GeoUtils/1.2/src/GeoUtils_min.js');
     ...
     * 派发画圆开始点击事件
     */
    DrawingManager.prototype._dispatchCircleClick = function (overlay, e) {
        var options = {
            'overlay'     : overlay,
            'drawingMode' : this._drawingType,
            offsetX: e.offsetX,
        ...
        this.dispatchEvent('circleClick', options);
    },
    /**
     * 派发鼠标画时移动事件
     */
    DrawingManager.prototype._dispatchMovelayComplete = function (overlay, calculate, e) {
        var options = {
            'overlay'     : overlay,
            'drawingMode' : this._drawingType,
            offsetX: e.offsetX,
        ...
        this.dispatchEvent(this._drawingType + 'complete', overlay);
        this.dispatchEvent('movelay', options);
    }
     ...
     */
    DrawingManager.prototype.isPointInRect = function(point, bounds) {
        //检查类型是否正确
     ...
     */
    DrawingManager.prototype.isPointInPolygon = function(point, polygon) {
        //检查类型
    ...
    DrawingTool.prototype._bind = function(panel){
        ...
        baidu.on(this.panel, 'click', function (e) {
            ...
            me.drawingManager.dispatchEvent('setDrawingMode', {drawingType: drawingType});
        });
    }
